 ...
 *
 */
var CMapCompleter = new Class().extends(Plugin);
CMapCompleter.definition = {
  ...
  {
    return {
      name: _("Command Mode Mode Map Completer"),
      description: _("Provides completion information of command mode mappings."),
      version: "0.1",
    };
  },
